...
c.setFont('Helvetica-Bold',8); c.drawString(M+150,y-8,'Current release:'); c.setFont('Helvetica',8); c.drawString(M+238,y-8,'1.0.0-beta.1')
...
('MIDI','The MIDI panel exposes independent CLOCK IN, CLOCK OUT, NOTES OUT and CC OUT. Clock In follows an external BPM. Clock Out sends the internal clock at 24 PPQN. Notes and CC output can be enabled independently. Use RESCAN / CLOSE after connecting or changing a MIDI device.','Screenshot_20260910-015644.png')]
...
c.setFont('Helvetica',7); c.drawString(M,54,'TTG 1.0.0-beta.1 - Exsiderurgica - 2026')
c.save()
print(OUT)
